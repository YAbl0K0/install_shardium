...
while 1 {
    ...
    expect {
        ...
        "Set the password to access the Dashboard:" {send "123QwErTy*\r"; exp_continue}
        "Enter the port (1025-65536) to access the web based Dashboard (default 8180):" {send "8180\r"; exp_continue}
